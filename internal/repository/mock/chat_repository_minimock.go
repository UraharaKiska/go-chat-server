...
//go:generate minimock -i github.com/UraharaKiska/go-chat-server/internal/repository.ChatRepository -o chat_repository_minimock.go -n ChatRepositoryMock -p mock
...
type ChatRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, chatInfo *model.ChatInfo) (i1 int64, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, chatInfo *model.ChatInfo)
...
func (mmCreate *mChatRepositoryMockCreate) Expect(ctx context.Context, chatInfo *model.ChatInfo) *mChatRepositoryMockCreate {
	...
	mmCreate.defaultExpectation.params = &ChatRepositoryMockCreateParams{ctx, chatInfo}
...
// ExpectChatInfoParam2 sets up expected param chatInfo for ChatRepository.Create
func (mmCreate *mChatRepositoryMockCreate) ExpectChatInfoParam2(chatInfo *model.ChatInfo) *mChatRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatRepositoryMock.Create mock is already set by Set")
	}
	...
	mmCreate.defaultExpectation.paramPtrs.chatInfo = &chatInfo
	mmCreate.defaultExpectation.expectationOrigins.originChatInfo = minimock.CallerInfo(1)

	return mmCreate
}

// Inspect accepts an inspector function that has same arguments as the ChatRepository.Create
func (mmCreate *mChatRepositoryMockCreate) Inspect(f func(ctx context.Context, chatInfo *model.ChatInfo)) *mChatRepositoryMockCreate {
...
func (mmCreate *mChatRepositoryMockCreate) Set(f func(ctx context.Context, chatInfo *model.ChatInfo) (i1 int64, err error)) *ChatRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mChatRepositoryMockCreate) When(ctx context.Context, chatInfo *model.ChatInfo) *ChatRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatRepositoryMock.Create mock is already set by Set")
	}
	...
	expectation := &ChatRepositoryMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &ChatRepositoryMockCreateParams{ctx, chatInfo},
...
func (mmCreate *ChatRepositoryMock) Create(ctx context.Context, chatInfo *model.ChatInfo) (i1 int64, err error) {
	...
	if mmCreate.inspectFuncCreate != nil {
		mmCreate.inspectFuncCreate(ctx, chatInfo)
	}

	mm_params := ChatRepositoryMockCreateParams{ctx, chatInfo}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := ChatRepositoryMockCreateParams{ctx, chatInfo}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.chatInfo != nil && !minimock.Equal(*mm_want_ptrs.chatInfo, mm_got.chatInfo) {
				mmCreate.t.Errorf("ChatRepositoryMock.Create got unexpected parameter chatInfo, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCreate.CreateMock.defaultExpectation.expectationOrigins.originChatInfo, *mm_want_ptrs.chatInfo, mm_got.chatInfo, minimock.Diff(*mm_want_ptrs.chatInfo, mm_got.chatInfo))
			}
	...
	if mmCreate.funcCreate != nil {
		return mmCreate.funcCreate(ctx, chatInfo)
	}
	mmCreate.t.Fatalf("Unexpected call to ChatRepositoryMock.Create. %v %v", ctx, chatInfo)
	return
}
