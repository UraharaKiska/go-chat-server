...
//go:generate minimock -i github.com/UraharaKiska/go-chat-server/internal/service.ChatService -o chat_service_minimock.go -n ChatServiceMock -p mock
...
type ChatServiceMock struct {
	...
	funcSendMessage          func(ctx context.Context, messageInfo *model.MessageInfo) (err error)
	funcSendMessageOrigin    string
	inspectFuncSendMessage   func(ctx context.Context, messageInfo *model.MessageInfo)
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.chat != nil && !minimock.Equal(*mm_want_ptrs.chat, mm_got.chat) {
				mmCreate.t.Errorf("ChatServiceMock.Create got unexpected parameter chat, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (mmSendMessage *mChatServiceMockSendMessage) Expect(ctx context.Context, messageInfo *model.MessageInfo) *mChatServiceMockSendMessage {
	...
	mmSendMessage.defaultExpectation.params = &ChatServiceMockSendMessageParams{ctx, messageInfo}
...
// ExpectMessageInfoParam2 sets up expected param messageInfo for ChatService.SendMessage
func (mmSendMessage *mChatServiceMockSendMessage) ExpectMessageInfoParam2(messageInfo *model.MessageInfo) *mChatServiceMockSendMessage {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("ChatServiceMock.SendMessage mock is already set by Set")
	}
...
func (mmSendMessage *mChatServiceMockSendMessage) Inspect(f func(ctx context.Context, messageInfo *model.MessageInfo)) *mChatServiceMockSendMessage {
...
func (mmSendMessage *mChatServiceMockSendMessage) Set(f func(ctx context.Context, messageInfo *model.MessageInfo) (err error)) *ChatServiceMock {
	if mmSendMessage.defaultExpectation != nil {
...
// Then helper
func (mmSendMessage *mChatServiceMockSendMessage) When(ctx context.Context, messageInfo *model.MessageInfo) *ChatServiceMockSendMessageExpectation {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("ChatServiceMock.SendMessage mock is already set by Set")
	}
	...
	expectation := &ChatServiceMockSendMessageExpectation{
		...
		params:             &ChatServiceMockSendMessageParams{ctx, messageInfo},
...
func (mmSendMessage *ChatServiceMock) SendMessage(ctx context.Context, messageInfo *model.MessageInfo) (err error) {
	...
	mm_params := ChatServiceMockSendMessageParams{ctx, messageInfo}
	...
	if mmSendMessage.SendMessageMock.defaultExpectation != nil {
		...
		mm_got := ChatServiceMockSendMessageParams{ctx, messageInfo}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.messageInfo != nil && !minimock.Equal(*mm_want_ptrs.messageInfo, mm_got.messageInfo) {
				mmSendMessage.t.Errorf("ChatServiceMock.SendMessage got unexpected parameter messageInfo, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmSendMessage.t.Fatalf("Unexpected call to ChatServiceMock.SendMessage. %v %v", ctx, messageInfo)
	return
}
